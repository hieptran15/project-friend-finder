...
document.addEventListener("DOMContentLoaded",function(){
    ...
    var nut = document.querySelector('ul.pagedit li');
	var  khoito=document.querySelector('.editchatbody');
    var nutx=document.querySelector('.editclose a i');

     nut.onclick=function(){
         console.log('okokok')
		
        khoito.classList.toggle('collapse');
       
	}

	// nutx.onclick=function(){
    //     khoito.classList.add('collapse');
    // }
    // var nut = document.querySelector('a.nutSeach');
    // var  khoito=document.querySelector('.editpageseach');
    // var  nen=document.querySelector('.nentrang');
    //  nut.onclick=function(){
    //      console.log('okokok')
    //     khoito.classList.toggle('collapse');
    //     nen.classList.toggle('collapse');s
    //  }
    //  nen.onclick=function(){
    //    khoito.classList.add('collapse');
    //    nen.classList.add('collapse');
    // }
